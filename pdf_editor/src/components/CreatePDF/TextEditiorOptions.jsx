...
const TextEditiorOptions = ({ optionDisplay, editorDisplay, displayValue, svg, option, description }) => {
     ...
     return (
          <>
               <li onClick={() => optionDisplay(displayValue)} className={`hover:animate-pulse p-3 transition duration-300 ease-in-out hover:bg-neutral-200 cursor-pointer rounded-xl relative mx-auto ${editorDisplay ? "w-fit" : "w-full"}`}>
                    <div>
