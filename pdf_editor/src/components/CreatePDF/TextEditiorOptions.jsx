...
const TextEditiorOptions = ({ getQuillContent }) => {

     const supportDisplay = 2      ;
     ...
     return (
          <>
               <ToastContainer />
               <nav className="w-full backdrop-blur-lg flex relative justify-between bg-transparent">
                    <div className="border-none bg-clip-padding  dark:bg-neutral-700">
                         <div className="border-r-2 rounded-r-xl bg-white relative w-fit">
                              <div className="">
                                   <div onClick={() => setEditorDisplay(editorDisplay ? false : true)} className='w-fit h-fit absolute right-4 text-white rounded-sm p-1 z-[2000] cursor-pointer'>
                                   ...
                                   <ul className='flex flex-col place-content-center'>
                                        ...
                                        <li className="w-fit my-2 p-3 transition duration-300 cursor-pointer rounded-xl relative">
                                             <div>
                                                  <div className="flex items-start space-x-4">
                                                       <div className="shrink-0">
                                                            <div className={`${editorDisplay ? "pr-0" : "pr-3"}`}>
                                        ...
                                        <li onClick={handleSaveDoc} className={`hover:animate-pulse p-3 transition duration-300 ease-in-out hover:bg-neutral-200 cursor-pointer rounded-xl relative mx-auto ${editorDisplay ? "w-fit" : "w-full"}`}>
                                             <div>
                                                  <div className="flex items-start space-x-4">
                                                       <div className="shrink-0">
                                                            <div className={`${editorDisplay ? "pr-0" : "pr-3"}`}>
                                   ...
                                   <ul>
                                        <li className={`hover:animate-pulse p-3 transition duration-300 ease-in-out hover:bg-neutral-200 cursor-pointer rounded-xl relative mx-auto ${editorDisplay ? "w-fit" : "w-full"}`}>
                                             <div>
                                                  <div className="flex items-start space-x-4">
                                                       <div className="shrink-0">
                                                            <div className={`${editorDisplay ? "pr-0" : "pr-3"}`}>
