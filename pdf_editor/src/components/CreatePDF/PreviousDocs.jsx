...
const PreviousDocs = () => {
     ...
     return (
          <div className='sm:pl-2 w-4/5 mx-auto h-fit pt-0 space-y-10'>
               <ToastContainer />
               ...
               <div>
                    ...
                    <div className='flex gap-x-5 w-full'>
                         <div className='border-2 border-black rounded-md px-2 flex place-content-center items-center w-full'>
                              <svg xmlns="http://www.w3.org/2000/svg" fill="gray" viewBox="0 0 24 24" strok-width="1.5" stroke="black" className="size-6">
                                   <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                              </svg>
                              <input onChange={(e) => setName(e.target.value)} value={name} type="text" id="input-group-1" className="w-full border-gray-300 text-gray-900 text-sm rounded-lg outline-none block p-2.5" placeholder="Your Name" />
                         </div>
                         <div className='border-2 border-black rounded-md px-2 flex place-content-center items-center w-full'>
                              ...
                              <input onChange={(e) => setJoinLink(e.target.value)} value={joinLink} type="text" id="input-group-1" className="w-full border-gray-300 text-gray-900 text-sm rounded-lg outline-none block p-2.5" placeholder="Enter link" />
                         </div>
                         <button onClick={joinDoc} className='text-lg font-semibold text-white  bg-gradient-to-tr from-[#3d83ff] via-[#846be6] to-[#7656f5] px-4 py-2 cursor-pointer rounded-md w-fit h-fit'>Join</button>
                    </div>
               </div>
          </div>
     )
