...
const DownLoadEditedPDF = ({ blob, downloadMessage }) => {
     return (
          <div className='mb-4 mx-auto w-fit items-center text-center place-content-center '>
               <div className='text-gray-800 my-4 mx-auto w-fit text-xl'>{downloadMessage}</div>
...
export default DownLoadEditedPDF