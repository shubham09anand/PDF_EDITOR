     ...
     return (
          <div className='mx-auto mt-5 bg-gradient-to-tr from-[#3d83ff] via-[#846be6] to-[#7656f5] rounded-xl h-fit w-fit'>
               <label htmlFor="dropzone-file" className="flex place-content-center items-center text-white w-fit h-fit min-h-[80px] min-w-[330px] space-x-5 justify-center rounded-lg cursor-pointer">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={`bi bi-file-pdf size-10 ${!type ? 'block' : 'hidden'}`} viewBox="0 0 16 16">
                    ...
                    <div className='font-bold text-2xl transition-opacity'>{labelText}</div>

                    <input multiple={multiple} accept={acceptType} id="dropzone-file" type="file" className="hidden" onChange={handleFileChange} />
               </label>
          </div>
     )
}
