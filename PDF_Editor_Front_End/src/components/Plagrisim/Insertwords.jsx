               ...
               <form>
                    <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                         <div className="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                              ...
                              <textarea onChange={(e) => setuserInput(e.target.value)} value={userInput} id="data" name='data' rows="10" className="w-full p-2 text-sm text-gray-900 bg-white outline-none rounded-lg resize-none border-2" placeholder="Write a comment..." required></textarea>
                         </div>
